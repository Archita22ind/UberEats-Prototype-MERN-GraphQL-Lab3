...
const restaurantSignUpInfo = (req, res, err) => {
  if (err instanceof multer.MulterError) {
    return res.status(500).json(err);
  }
  let sql =
    "INSERT INTO  RestaurantDetails (RestaurantName,Passwordvalue,Address,City,State,Country,ContactNumber,EmailID) VALUES (?,?,?,?,?,?,?,?)";
